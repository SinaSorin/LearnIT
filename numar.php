...
<div class="bara">
	...
	if(!isset($_SESSION['u_id']))
		echo '
				<a href="#" data-toggle="modal" data-target="#register-modal"><div class="lr divs link">Inregisteaza-te</div></a>
...
if(isset($_SESSION['u_id']))
{
	...
	$sql8="SELECT * FROM loto WHERE id_user=$id_user AND data=CURDATE()";
		...
		<form method='POST' action='numar3.php'>
			<center>
			<input type='number' min='1' max='100' class='numar' name='nr' required /></br>
...
echo 'Deja ai fct provocarea azi!Incearca maine!';}
	?>
